...
Генерирует `geosite.dat` и рулсеты для Mihomo/sing-box с категоризированными списками доменов для маршрутизации трафика РФ/РБ.
...
### Mihomo (.mrs рулсеты) и sing-box (.srs рулсеты)
